...
for project in ${projects} ; do
	...
	(metadata > results/${project_base}-openreviews.txt && openreviews -p ${project} -l 30 ${EXTRA_ARGS} -o results/${project_base}-openreviews.txt)
	openreviews -p ${project} --html -l 30 ${EXTRA_ARGS} -o results/${project_base}-openreviews.html
